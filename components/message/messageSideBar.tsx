...
import { BarChart2, Home, Layers, Menu, MessageCircle, PanelLeft, Star, Users } from 'lucide-react';


const   MessageSideBar = () => {
    
  return (
    <div className="flex w-16 flex-col items-center border-l border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 py-4">
    <div className="mb-6">
